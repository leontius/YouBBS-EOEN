...
$query_sql = "SELECT a.id,a.cid,a.uid,a.ruid,a.title,a.addtime,a.edittime,a.comments,a.visible,a.isred,c.name as cname,u.avatar as uavatar,u.name as author,ru.name as rauthor,u.flag as flag
